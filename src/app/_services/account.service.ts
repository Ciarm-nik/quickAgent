...
export class AccountService {
    ...
    searchUsers(searchParams: any): Observable<User[]> {
      ...
      if(searchParams.active !== '') { // verifichiamo se active non è una stringa vuota
        params = params.append('active', searchParams.active);
      }
      console.log('searchUsers called with params: ', searchParams);
      return this.http.get<User[]>(`${environment.apiUrl}/users`, { params })
        .pipe(
          tap(users => console.log('searchUsers result: ', users)),
        );
    }
